        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              className="font-mono mt-1 min-h-[150px]"
              placeholder="Enter the corrected version of the code..."
            />
          </div>
          ...
          {/* Error Descriptions */}
          <div>
            <Label>Error Descriptions</Label>
          ...
          <div>
            ...
            <Textarea
              ...
              className="mt-1"
              placeholder="Enter a hint to help students identify the errors..."
            />
          </div>
          ...
          <div className="border border-slate-200 rounded-lg p-4 bg-slate-50">
            ...
            {showPreview && (
              <div className="space-y-4">
                <div>
                  <h4 className="text-sm font-medium mb-2">Code with Errors:</h4>
                ...
                {question.errorDescriptions && question.errorDescriptions.length > 0 && (
                  <div>
                    <h4 className="text-sm font-medium mb-2">Error Descriptions:</h4>
